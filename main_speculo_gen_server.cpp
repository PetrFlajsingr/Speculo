...
namespace speculo::gen {
        ...
        Value &insert(const Key &key, const Value &value) {
            if (auto opt = get(key); opt.has_value()) {
                *opt = value;
                ...
                indexMap[key] = index;
                return new (&data()[index]) Value{*opt};
            }
        }
    ...
    public:
        explicit ProjectWatchServer(asio::ip::tcp::endpoint tcpEndpoint) : endpoint{tcpEndpoint} {
        }
        ...
        asio::awaitable<void> handleMessage(asio::ip::tcp::socket &socket, MessageType messageType, const nlohmann::json &jsonMsg) {
            ...
            switch (messageType) {
                ...
                case RegisterProject: {
                    ...
                    auto &newProjectInfo = (*projectInfos)[registerMsg.project];
