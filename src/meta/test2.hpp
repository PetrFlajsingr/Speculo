...
namespace pf::meta::details {
    ...
    struct StaticInfo<ID{0x8a5eea7eb9fa4825u, 0x12c601cd168aca3u}> {
        ...
        constexpr static RangeOf<Info> auto MemberFunctions =
                pf::meta::details::make_array<Info>(ID{0x23561358310a0cbeu, 0xebb11a197749f289u});
        ...
        constexpr static RangeOf<Info> auto MemberVariables = pf::meta::details::make_array<Info>(
                ID{0xb85e7b5dbcb67be4u, 0x5e9ed30670dab999u}, ID{0x685f6a6c23efb491u, 0x30d16e2ef7d8ffb1u},
                ID{0xb55d3aef7b4ffe23u, 0x8f06566db59c83b7u}, ID{0xaa5626b34ff6b026u, 0xd0e32ef8310e1abau},
                ID{0x875a46f77d5b032du, 0x5ed1a863bb6b3e8eu});
    ...
    struct StaticInfo<ID{0xb85e7b5dbcb67be4u, 0x5e9ed30670dab999u}> {
        ...
        struct BitfieldAccessor {
            ...
            constexpr explicit(false) operator int() const { return parent->b1; }

        private:
            Parent *parent;
        };

        constexpr static BitfieldAccessor<false> CreateBitfieldAccessor(SimpleStruct *self) { return BitfieldAccessor<false>{self}; }
        constexpr static BitfieldAccessor<true> CreateBitfieldAccessor(const SimpleStruct *self) { return BitfieldAccessor<true>{self}; }
    ...
    struct StaticInfo<ID{0x685f6a6c23efb491u, 0x30d16e2ef7d8ffb1u}> {
        ...
        struct BitfieldAccessor {
            ...
            constexpr explicit(false) operator int() const { return parent->b2; }
    ...
    struct StaticInfo<ID{0xb55d3aef7b4ffe23u, 0x8f06566db59c83b7u}> {
        ...
        struct BitfieldAccessor {
            ...
            constexpr explicit(false) operator int() const { return parent->b3; }
    ...
    struct StaticInfo<ID{0xaa5626b34ff6b026u, 0xd0e32ef8310e1abau}> {
        ...
        struct BitfieldAccessor {
            ...
            constexpr explicit(false) operator int() const { return parent->b4; }
    ...
    struct StaticInfo<ID{0x875a46f77d5b032du, 0x5ed1a863bb6b3e8eu}> {
        ...
        struct BitfieldAccessor {
            ...
            constexpr explicit(false) operator int() const { return parent->b5; }
    ...
    struct StaticInfo<ID{0xcb52df3a8620d8fbu, 0xa4b482a29391dc9bu}> {
        ...
        constexpr static RangeOf<Info> auto MemberVariables =
                pf::meta::details::make_array<Info>(ID{0x995e8284d41542d4u, 0x6ed26f5e7949a893u});
        constexpr static RangeOf<Info> auto StaticVariables = pf::meta::details::make_array<Info>();
    };
