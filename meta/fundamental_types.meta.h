...
namespace pf::meta::details {
    ...
    [[nodiscard]] consteval ID getTypeId<const bool>() {
        return ID{0x0u, 0x22u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<bool &>() {
        return ID{0x0u, 0x23u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<bool &&>() {
        return ID{0x0u, 0x24u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const bool &>() {
        return ID{0x0u, 0x25u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<bool *>() {
        return ID{0x0u, 0x26u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const bool *>() {
        return ID{0x0u, 0x27u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<const char>() {
        return ID{0x0u, 0x28u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char &>() {
        return ID{0x0u, 0x29u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char &&>() {
        return ID{0x0u, 0x30u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char &>() {
        return ID{0x0u, 0x31u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char *>() {
        return ID{0x0u, 0x32u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char *>() {
        return ID{0x0u, 0x33u};
    }

    // signed char
    template<>
    struct StaticInfo<ID{0x0u, 0x3u}> : FundamentalStaticTypeInfo<signed char, ID{0x0u, 0x3u}, StringLiteral{
            "signed char"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<const signed char>() {
        return ID{0x0u, 0x34u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<signed char &>() {
        return ID{0x0u, 0x35u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<signed char &&>() {
        return ID{0x0u, 0x36u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const signed char &>() {
        return ID{0x0u, 0x37u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<signed char *>() {
        return ID{0x0u, 0x38u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const signed char *>() {
        return ID{0x0u, 0x39u};
    }

    // unsigned char
    template<>
    struct StaticInfo<ID{0x0u, 0x4u}> : FundamentalStaticTypeInfo<unsigned char, ID{0x0u, 0x4u}, StringLiteral{
            "unsigned char"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<const unsigned char>() {
        return ID{0x0u, 0x40u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned char &>() {
        return ID{0x0u, 0x41u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned char &&>() {
        return ID{0x0u, 0x42u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned char &>() {
        return ID{0x0u, 0x43u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned char *>() {
        return ID{0x0u, 0x44u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned char *>() {
        return ID{0x0u, 0x45u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<const char8_t>() {
        return ID{0x0u, 0x46u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char8_t &>() {
        return ID{0x0u, 0x47u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char8_t &&>() {
        return ID{0x0u, 0x48u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char8_t &>() {
        return ID{0x0u, 0x49u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char8_t *>() {
        return ID{0x0u, 0x50u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char8_t *>() {
        return ID{0x0u, 0x51u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<const char16_t>() {
        return ID{0x0u, 0x52u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char16_t &>() {
        return ID{0x0u, 0x53u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char16_t &&>() {
        return ID{0x0u, 0x54u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char16_t &>() {
        return ID{0x0u, 0x55u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char16_t *>() {
        return ID{0x0u, 0x56u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char16_t *>() {
        return ID{0x0u, 0x57u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<const char32_t>() {
        return ID{0x0u, 0x58u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char32_t &>() {
        return ID{0x0u, 0x59u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char32_t &&>() {
        return ID{0x0u, 0x60u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char32_t &>() {
        return ID{0x0u, 0x61u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<char32_t *>() {
        return ID{0x0u, 0x62u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const char32_t *>() {
        return ID{0x0u, 0x63u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<const short>() {
        return ID{0x0u, 0x64u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<short &>() {
        return ID{0x0u, 0x65u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<short &&>() {
        return ID{0x0u, 0x66u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const short &>() {
        return ID{0x0u, 0x67u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<short *>() {
        return ID{0x0u, 0x68u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const short *>() {
        return ID{0x0u, 0x69u};
    }

    // unsigned short
    template<>
    struct StaticInfo<ID{0x0u, 0x10u}> : FundamentalStaticTypeInfo<unsigned short, ID{0x0u, 0x10u}, StringLiteral{
            "unsigned short"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<unsigned short>() {
        return ID{0x0u, 0x10u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned short>() {
        return ID{0x0u, 0x70u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned short &>() {
        return ID{0x0u, 0x71u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned short &&>() {
        return ID{0x0u, 0x72u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned short &>() {
        return ID{0x0u, 0x73u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned short *>() {
        return ID{0x0u, 0x74u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned short *>() {
        return ID{0x0u, 0x75u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<int>() {
        return ID{0x0u, 0x11u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const int>() {
        return ID{0x0u, 0x76u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<int &>() {
        return ID{0x0u, 0x77u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<int &&>() {
        return ID{0x0u, 0x78u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const int &>() {
        return ID{0x0u, 0x79u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<int *>() {
        return ID{0x0u, 0x80u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const int *>() {
        return ID{0x0u, 0x81u};
    }

    // unsigned int
    template<>
    struct StaticInfo<ID{0x0u, 0x12u}> : FundamentalStaticTypeInfo<unsigned int, ID{0x0u, 0x12u}, StringLiteral{
            "unsigned int"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<unsigned int>() {
        return ID{0x0u, 0x12u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned int>() {
        return ID{0x0u, 0x82u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned int &>() {
        return ID{0x0u, 0x83u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned int &&>() {
        return ID{0x0u, 0x84u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned int &>() {
        return ID{0x0u, 0x85u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned int *>() {
        return ID{0x0u, 0x86u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned int *>() {
        return ID{0x0u, 0x87u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<long>() {
        return ID{0x0u, 0x13u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long>() {
        return ID{0x0u, 0x88u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long &>() {
        return ID{0x0u, 0x89u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long &&>() {
        return ID{0x0u, 0x90u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long &>() {
        return ID{0x0u, 0x91u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long *>() {
        return ID{0x0u, 0x92u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long *>() {
        return ID{0x0u, 0x93u};
    }

    // unsigned long
    template<>
    struct StaticInfo<ID{0x0u, 0x14u}> : FundamentalStaticTypeInfo<unsigned long, ID{0x0u, 0x14u}, StringLiteral{
            "unsigned long"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<unsigned long>() {
        return ID{0x0u, 0x14u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned long>() {
        return ID{0x0u, 0x94u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned long &>() {
        return ID{0x0u, 0x95u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned long &&>() {
        return ID{0x0u, 0x96u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned long &>() {
        return ID{0x0u, 0x97u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned long *>() {
        return ID{0x0u, 0x98u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned long *>() {
        return ID{0x0u, 0x99u};
    }

    // long long
    template<>
    struct StaticInfo<ID{0x0u, 0x15u}> : FundamentalStaticTypeInfo<long long, ID{0x0u, 0x15u}, StringLiteral{
            "long long"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<long long>() {
        return ID{0x0u, 0x15u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long long>() {
        return ID{0x0u, 0x100u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long long &>() {
        return ID{0x0u, 0x101u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long long &&>() {
        return ID{0x0u, 0x102u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long long &>() {
        return ID{0x0u, 0x103u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long long *>() {
        return ID{0x0u, 0x104u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long long *>() {
        return ID{0x0u, 0x105u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<unsigned long long>() {
        return ID{0x0u, 0x16u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned long long>() {
        return ID{0x0u, 0x106u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned long long &>() {
        return ID{0x0u, 0x107u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned long long &&>() {
        return ID{0x0u, 0x108u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned long long &>() {
        return ID{0x0u, 0x109u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<unsigned long long *>() {
        return ID{0x0u, 0x110u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const unsigned long long *>() {
        return ID{0x0u, 0x111u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<float>() {
        return ID{0x0u, 0x17u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const float>() {
        return ID{0x0u, 0x112u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<float &>() {
        return ID{0x0u, 0x113u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<float &&>() {
        return ID{0x0u, 0x114u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const float &>() {
        return ID{0x0u, 0x115u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<float *>() {
        return ID{0x0u, 0x116u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const float *>() {
        return ID{0x0u, 0x117u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<double>() {
        return ID{0x0u, 0x18u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const double>() {
        return ID{0x0u, 0x118u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<double &>() {
        return ID{0x0u, 0x119u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<double &&>() {
        return ID{0x0u, 0x120u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const double &>() {
        return ID{0x0u, 0x121u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<double *>() {
        return ID{0x0u, 0x122u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const double *>() {
        return ID{0x0u, 0x123u};
    }

    // long double
    template<>
    struct StaticInfo<ID{0x0u, 0x19u}> : FundamentalStaticTypeInfo<long double, ID{0x0u, 0x19u}, StringLiteral{
            "long double"}> {
    };
    template<>
    ...
    [[nodiscard]] consteval ID getTypeId<const long double>() {
        return ID{0x0u, 0x124u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long double &>() {
        return ID{0x0u, 0x125u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long double &&>() {
        return ID{0x0u, 0x126u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long double &>() {
        return ID{0x0u, 0x127u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<long double *>() {
        return ID{0x0u, 0x128u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const long double *>() {
        return ID{0x0u, 0x129u};
    }
    ...
    [[nodiscard]] consteval ID getTypeId<void *>() {
        return ID{0x0u, 0x130u};
    }

    template<>
    [[nodiscard]] consteval ID getTypeId<const void *>() {
        return ID{0x0u, 0x131u};
    }

    // std::nullptr_t
    template<>
    struct StaticInfo<ID{0x0u, 0x21u}>
            : FundamentalStaticTypeInfo<std::nullptr_t, ID{0x0u, 0x21u}, StringLiteral{"nullptr_t"}, StringLiteral{
                    "std::nullptr_t"}> {
    };

    template<>
    [[nodiscard]] consteval ID getTypeId<std::nullptr_t>() {
        return ID{0x0u, 0x21u};
    }
