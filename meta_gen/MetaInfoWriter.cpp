...
namespace pf::meta_gen {
    ...
    void MetaInfoWriter::writeEnumInfo(const EnumTypeInfo &enumInfo) {
        if (ContainsNoSTIAttribute(enumInfo.attributes)) {
            spdlog::trace("MetaInfoWrite: skipping generation for '{}' due to presence of no_sti attribute",
                          enumInfo.fullName);
            return;
        }
        ...
        for (auto &[name, info]: enumInfo.values) {
...
)fmt", info.fullName, info.sourceLocation.filename, info.sourceLocation.line,
                              info.sourceLocation.column));
            ...
            write(fmt::format(StaticValueInfoTemplate_Enum, "details"_a = createDetailsStruct(detailsContents),
                              ...
                              "source_file"_a = enumInfo.sourceLocation.filename,
                              ...
                              "underlying_type"_a = enumInfo.underlyingType, "underlying_value"_a = valueStr,
        ...
        write(fmt::format(StaticTypeInfoTemplate_Enum, "details"_a = createDetailsStruct(detailsContents),
                          ...
                          "source_column"_a = enumInfo.sourceLocation.column, "attributes"_a = attributesStr,
                          "name"_a = enumInfo.name,
                          ...
                          "lref_type_id"_a = idToString(enumInfo.lrefId),
                          "const_lref_type_id"_a = idToString(enumInfo.constLrefId),
    ...
    void MetaInfoWriter::writeRecordInfo(const RecordTypeInfo &recordInfo) {
        ...
        write(fmt::format(R"fmt(// Record {}, location {}:{}:{} )fmt", recordInfo.fullName,
                          recordInfo.sourceLocation.filename, recordInfo.sourceLocation.line,
                          recordInfo.sourceLocation.column));

        {
            ...
            write(fmt::format(StaticTypeInfoTemplate_Record, "type_id"_a = idToString(recordInfo.id),
                              ...
                              "name"_a = recordInfo.name, "full_name"_a = recordInfo.fullName,
                              ...
                              "const_type_id"_a = idToString(recordInfo.constId),
                              "lref_type_id"_a = idToString(recordInfo.lrefId),
                              "const_lref_type_id"_a = idToString(recordInfo.constLrefId),
                              "rref_type_id"_a = idToString(recordInfo.rrefId),
                              "ptr_type_id"_a = idToString(recordInfo.ptrId),
                              "const_ptr_type_id"_a = idToString(recordInfo.constPtrId)));


            write(fmt::format(R"fmt(// Record {} static info getters
)fmt", recordInfo.fullName));
...
)fmt", recordInfo.fullName, baseInfo.fullName));

            write(fmt::format(StaticTypeInfoTemplate_Base, "full_name"_a = baseInfo.fullName,
                              "id"_a = idToString(baseInfo.id),
                              "details"_a = "", "type_id"_a = idToString(idGenerator->generateId(baseInfo.fullName)),
                              "source_file"_a = baseInfo.sourceLocation.filename,
                              "source_line"_a = baseInfo.sourceLocation.line,
                              "source_column"_a = baseInfo.sourceLocation.column,
                              "is_public"_a = baseInfo.access == Access::Public,
                              "is_protected"_a = baseInfo.access == Access::Protected,
                              "is_private"_a = baseInfo.access == Access::Private,
...
)fmt", recordInfo.fullName, ctorInfo.fullName, argInfo.fullName));

                write(fmt::format(StaticTypeInfoTemplate_Argument, "full_name"_a = argInfo.fullName,
                                  "id"_a = idToString(argInfo.id),
                                  "details"_a = createDetailsStruct(detailsContents),
                                  "type_id"_a = idToString(argInfo.typeId),
                                  "source_file"_a = argInfo.sourceLocation.filename,
                                  "source_line"_a = argInfo.sourceLocation.line,
            ...
            if (!skipWraps) {
                lambdaWraps.append(
                                fmt::format(
                                        ...
                                        "args"_a = argsWithNames,
                                        "type"_a = recordInfo.fullName, "args_fwd"_a = argsWithForward,
...
)fmt", recordInfo.fullName, ctorInfo.fullName));

            write(fmt::format(StaticTypeInfoTemplate_Constructor, "full_name"_a = ctorInfo.fullName,
                              "id"_a = idToString(ctorInfo.id),
                              "details"_a = createDetailsStruct(detailsContents),
                              "type_id"_a = idToString(recordInfo.id),
                              "source_file"_a = ctorInfo.sourceLocation.filename,
                              "source_line"_a = ctorInfo.sourceLocation.line,
                              "source_column"_a = ctorInfo.sourceLocation.column, "attributes"_a = attributesStr,
                              "is_public"_a = ctorInfo.access == Access::Public,
                              "is_protected"_a = ctorInfo.access == Access::Protected,
                              "is_private"_a = ctorInfo.access == Access::Private,
                              "is_explicit"_a = ctorInfo.isExplicit,
                              ...
                              "ctor_wraps"_a = lambdaWraps, "is_inline"_a = ctorInfo.isInline,
            ...
            if (ContainsNoSTIAttribute(destructor.attributes)) {
                ...
                std::string wrapLambdaStr =
                        fmt::format(R"([]({full_type} &self) {modifier} -> void {{ self.~{type}(); }})",
                                    "full_type"_a = recordInfo.fullName, "type"_a = recordInfo.name,
                                    "modifier"_a = dtorModifier);

                write(fmt::format(R"fmt(// Record {} destructor {}
)fmt", recordInfo.fullName, destructor.fullName));

                write(fmt::format(StaticTypeInfoTemplate_Destructor, "full_name"_a = destructor.fullName,
                                  "id"_a = idToString(destructor.id),
                                  "details"_a = createDetailsStruct(detailsContents),
                                  "type_id"_a = idToString(recordInfo.id),
                                  "source_file"_a = destructor.sourceLocation.filename,
                                  "source_line"_a = destructor.sourceLocation.line,
                                  "source_column"_a = destructor.sourceLocation.column,
                                  ...
                                  "is_private"_a = destructor.access == Access::Private,
                                  "is_constexpr"_a = destructor.isConstexpr,
                                  ...
                                  "dtor_wrap_lambda"_a = wrapLambdaStr));
            }
        }
...
)fmt", recordInfo.fullName, mbrFncInfo.fullName, argInfo.fullName));
...
)fmt", recordInfo.fullName, mbrFncInfo.fullName));
            ...
            if (mbrFncInfo.isConsteval) {
                ...
                if (argsWithNames.empty()) {
                    constevalWrapStr = fmt::format(
                            ...
                            "this_type"_a = mbrFncInfo.isConst ? fmt::format("const {}", recordInfo.fullName)
                                                               : recordInfo.fullName,
                            "modifier"_a = "consteval", "result_type"_a = mbrFncInfo.returnTypeName,
                            "fnc"_a = mbrFncInfo.name,
                ...
                write(fmt::format(StaticTypeInfoTemplate_ConstevalMemberFunction, "full_name"_a = mbrFncInfo.fullName,
                                  "id"_a = idToString(mbrFncInfo.id),
                                  "details"_a = createDetailsStruct(detailsContents),
                                  "type_id"_a = idToString(recordInfo.id),
                                  "source_file"_a = mbrFncInfo.sourceLocation.filename,
                                  "source_line"_a = mbrFncInfo.sourceLocation.line,
                                  "source_column"_a = mbrFncInfo.sourceLocation.column,
                                  ...
                                  "arguments"_a = idsToStringMakeArray(mbrFncInfo.arguments),
                                  "consteval_wrap"_a = constevalWrapStr,
                                  "member"_a = mbrFncInfo.fullName,
                                  "is_inline_specified"_a = mbrFncInfo.isInlineSpecified));
            } else {
                const auto mbrFncType =
                        fmt::format("{return_type}({type}::*MemberPtr)({arguments})",
                                    "return_type"_a = mbrFncInfo.returnTypeName,
        ...
        for (const auto &mbrVarInfo: recordInfo.memberVariables) {
            ...
            const auto mbrVarType =
                    fmt::format("{return_type} {type}::* MemberPtr", "return_type"_a = mbrVarInfo.typeName,
            ...
            if (mbrVarInfo.isBitfield) {
                ...
                memberPtrBlock = fmt::format("constexpr static {member_type} = &{member};",
                                             "member_type"_a = mbrVarType,
                                             "member"_a = mbrVarInfo.fullName);
            }

            write(fmt::format(R"fmt(// Record {} member variable {}
)fmt", recordInfo.fullName, mbrVarInfo.fullName));
            ...
            write(fmt::format(StaticTypeInfoTemplate_MemberVariable, "full_name"_a = mbrVarInfo.fullName,
                              ...
                              "type_id"_a = idToString(recordInfo.id),
                              "source_file"_a = mbrVarInfo.sourceLocation.filename,
                              "source_line"_a = mbrVarInfo.sourceLocation.line,
                              "source_column"_a = mbrVarInfo.sourceLocation.column,
        ...
        for (const auto &statFncInfo: recordInfo.staticFunctions) {
...
)fmt", recordInfo.fullName, statFncInfo.fullName, argInfo.fullName));
            ...
            const auto statFncType = fmt::format("{return_type}(*MemberPtr)({arguments})",
                                                 "return_type"_a = statFncInfo.returnTypeName,
                                                 "arguments"_a = arguments);

            write(fmt::format(R"fmt(// Record {} static function {}
)fmt", recordInfo.fullName, statFncInfo.fullName));
            ...
            if (statFncInfo.isConsteval) {
                ...
                const std::string constevalWrapStr =
                        fmt::format(
                                R"([]({args}) {modifier} -> {result_type} {{ {return} self->{fnc}({arg_names}); }})",
                                "args"_a = argsWithNames, "arg_names"_a = argNames, "type"_a = recordInfo.fullName,
                                "modifier"_a = "consteval", "result_type"_a = statFncInfo.returnTypeName,
                                "fnc"_a = statFncInfo.name,
                ...
                write(fmt::format(StaticTypeInfoTemplate_ConstevalStaticFunction, "full_name"_a = statFncInfo.fullName,
                                  "id"_a = idToString(statFncInfo.id),
                                  "details"_a = createDetailsStruct(detailsContents),
                                  "type_id"_a = idToString(recordInfo.id),
                                  "source_file"_a = statFncInfo.sourceLocation.filename,
                                  "source_line"_a = statFncInfo.sourceLocation.line,
                                  "source_column"_a = statFncInfo.sourceLocation.column,
        ...
        for (const auto &statVarInfo: recordInfo.staticVariables) {
...
)fmt", recordInfo.fullName, statVarInfo.fullName));
            ...
            write(fmt::format(StaticTypeInfoTemplate_StaticVariable, "full_name"_a = statVarInfo.fullName,
                              ...
                              "type_id"_a = idToString(recordInfo.id),
                              "source_file"_a = statVarInfo.sourceLocation.filename,
                              "source_line"_a = statVarInfo.sourceLocation.line,
                              "source_column"_a = statVarInfo.sourceLocation.column,
                              ...
                              "is_constexpr"_a = statVarInfo.isConstexpr,
                              ...
                              "is_inline"_a = statVarInfo.isInline,
    ...
    std::string MetaInfoWriter::StringifyAttributes(const std::vector<Attribute> &attrs,
        ...
        for (auto i = 0ull; i < attrs.size(); ++i) {
            ...
            attributesString.append(fmt::format(R"(Attribute{{"{}", "{}", std::span<const std::string_view>{{{}}}}}, )",
                                                attr.nnamespace,
    ...
    std::string MetaInfoWriter::CreateAttributeArgArray(std::string_view name, const Attribute &attr) {
        ...
        attributeArgsStr.append(
                fmt::format("constexpr static auto {} = pf::meta::details::make_array<std::string_view>(", name));
