...
export module speculo.gen:attribute_parser;
import speculo;
import :structs;
...
namespace speculo::gen {
    ...
    private:
        ...
        struct TokensRange {
            ...
            TokensRange(TokensIter b, TokensIter e) : begin_{std::move(b)}, end_{std::move(e)} { assert(begin_ <= end_); }
        ...
        [[nodiscard]] static bool Contains(TokensRange range, RangeOf<clang::tok::TokenKind> auto &&kinds) {
