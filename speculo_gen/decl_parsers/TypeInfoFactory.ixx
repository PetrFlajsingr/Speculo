...
export module speculo.gen:type_info_factory;
import :structs;
import :id_generator;
import speculo;
...
namespace speculo::gen {
    ...
    FundamentalTypeInfo getFundamentalTypeInfo(std::string_view fullTypeName, IdGenerator &idGenerator) {
    ...
    IncompleteTypeInfo getIncompleteTypeInfo(std::string_view typeName, IdGenerator &idGenerator) {
